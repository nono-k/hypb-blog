...
簡易的ですが、画像を4色に分解してハーフトーンを再現する方法を紹介しています。
ドットにノイズを加えたりしているので、よりリアルな表現になっているかと思います。
また、参考にした英語のチュートリアルについても紹介しています。

<RecommendLink
  items={[
    {
      title:
        "GLSLでハーフトーンシェーダを実装する",
      link: "glsl-halftone-shader",
      image: "glsl-halftone-shader.jpg",
    },
  ]}
/>
